...
Matrix createLocalK(int e,mesh &m){
    ...
    productRealMatrix(tau*J/(6*4*D),productMatrixMatrix(g_matrix,productMatrixMatrix(Alpha,Beta,2,2,6),6,2,6),matrixA);
    ...
    productRealMatrix((2*lambda*J)/(3*6*D),productMatrixMatrix(g_matrix,productMatrixMatrix(Alpha,BPrima,2,2,3),6,2,3),matrixG);
